...
from cardinal.bot import CardinalBot, CardinalBotFactory, source
...
class TestCardinalBot(object):
    ...
    def get_user():
        ...
        return "{}!{}@{}".format(user.nick, user.user, user.host), user
    ...
    def test_irc_KICK(self):
        ...
        self.cardinal.irc_KICK(prefix, [nick, channel, message])
    ...
    def test_irc_KICK_no_message(self):
        ...
        self.cardinal.irc_KICK(prefix, [nick, channel])
